...
export const Footer = ({classNames}) => {
  return (
    <footer className={`w-full bg-slate-950 text-white py-10 px-4 md:px-10 text-center gap-5 flex flex-col md:flex-row md:justify-between md:items-start ${classNames}`}>
      <div>
